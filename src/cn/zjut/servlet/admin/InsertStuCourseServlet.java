...
@WebServlet(name = "InsertStuCourseServlet", urlPatterns = "/admin/insertStuCourse.do")
public class InsertStuCourseServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String stuName = request.getParameter("insertStuName");
        String courseName = request.getParameter("insertCourseName");
        ...
        if (InsertStuCourseService.insertStudentCourse(student.getId(), course.getId(), term)) {
