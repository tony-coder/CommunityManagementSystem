...
import cn.zjut.service.course.InsertCourseService;
...
@WebServlet(name = "InsertCourseServlet", urlPatterns = {"/admin/insertCourse.do"})
public class InsertCourseServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (InsertCourseService.insertCourse(id, name, teacher, term, clubName)) {
