...
<aside class="app-sidebar">
    ...
    <ul class="app-menu">
        ...
        <li><a class="app-menu__item" href="<%=basePath%>admin/course.do"><i class="app-menu__icon fa fa-edit"></i><span
                class="app-menu__label">课程管理</span></a></li>
...
<main class="app-content">
    <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<%=basePath%>admin/club.do">课程管理</a></li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12">
            ...
            <form class="tile" id="deleteCourseForm" method="post">
                ...
                <div class="tile-body">
                    <table class="table table-hover table-bordered" id="scoreTable">
                        ...
                        <tbody>
                        <c:forEach items="${clubCourselist}" var="course" varStatus="status">
                            <tr>
                                <td>${course.term}</td>
                                <td>${course.id}</td>
                                <td>${course.name}</td>
