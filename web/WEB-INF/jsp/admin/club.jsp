...
<main class="app-content">
    <div class="app-title">
        <div>
            <h1><i class="fa fa fa-user"></i> 社团管理</h1>
        </div>
        <ul class="app-breadcrumb breadcrumb">
            <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
            <li class="breadcrumb-item"><a href="<%=basePath%>admin/club.do">社团管理</a></li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                <form class="form-group col-md-12" id="updateClubForm" action="<%=basePath%>admin/insertClub.do">
                    <div class="form-group">
                        <div class="row">
                            <div class="col-lg-3">
                                <label>社团编号</label>
                                <input class="form-control" type="text" name="insertId" placeholder="请输入社团编号" required>
                            </div>
                            <div class="col-lg-3">
                                <label>社团名称</label>
                                <input class="form-control" type="text" name="insertName" placeholder="请输入社团名称"
                                       required>
                            </div>
                            <div class="col-lg-3">
                                <label>社团简介</label>
                                <input class="form-control" type="text" name="insertDescription" placeholder="请输入社团简介"
                                       required>
                            </div>
                    ...
                    <div class="tile-footer">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <button class="btn btn-primary" type="button" onclick="updateClub('<%=basePath%>');">修改</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                <form class="form-group col-md-12" action="<%=basePath%>admin/queryClub.do">
                    <div class="form-group">
                        <div class="row">
                            <div class="col-lg-3">
                                <label>社团编号</label>
                                <input class="form-control" type="text" name="club_id" placeholder="请输入社团编号">
                            </div>
                            <div class="col-lg-3">
                                <label>社团名称</label>
                                <input class="form-control" type="text" name="club_name" placeholder="请输入社团名称">
                            </div>
                        </div>
                    </div>
                    <div class="tile-footer">
    ...
    <div class="row">
        <div class="col-md-12">
            <form class="tile" id="clubForm" method="post">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-danger"
                                       href="javascript:deleteClub('<%=basePath%>', '${club.id}');">删除</a>
                                </td>
                                <td>
                                    <a class="btn btn-primary"
                                       href="javascript:uploadImage('<%=basePath%>', '${club.id}');">上传</a>
                                </td>
                ...
                <input type="file" name="fileName" size="30"> ${message}
            </form>
        </div>
...
<script type="text/javascript">
    ...
    function deleteClub(basePath, clubId) {
        var id = document.getElementById("clubId");
        id.value = clubId;
        // alert(id.value);
        var deleteClubForm = document.getElementById("clubForm");
        deleteClubForm.setAttribute("action", basePath + "admin/deleteClub.do");
        deleteClubForm.submit();
    }

    function uploadImage(basePath, clubId) {
        var id = document.getElementById("clubId");
        id.value = clubId;

        var uploadClubForm = document.getElementById("clubForm");
        uploadClubForm.setAttribute("enctype", "multipart/form-data");
        uploadClubForm.setAttribute("action", basePath + "admin/uploadImage.do");
        uploadClubForm.submit();
