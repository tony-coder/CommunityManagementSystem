...
<aside class="app-sidebar">
    ...
    <ul class="app-menu">
        ...
        <li><a class="app-menu__item" href="<%=basePath%>admin/StuCourse.do"><i class="app-menu__icon fa fa-edit"></i><span
...
<main class="app-content">
    <div class="app-title">
        <div>
            <h1><i class="fa fa fa-user"></i> 课程管理</h1>
        </div>
        <ul class="app-breadcrumb breadcrumb">
            <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
            <li class="breadcrumb-item"><a href="<%=basePath%>admin/course.do">课程管理</a></li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                <form class="form-group col-md-12" id="updateCourseForm" action="<%=basePath%>admin/insertCourse.do">
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <label>社团</label>
                                <select class="form-control" name="insertClubName" required>
                                    <option disabled selected>请选择社团</option>
                                    <c:forEach items="${clublist}" var="club" varStatus="">
                                        <option>
                                            <td>${club.name}</td>
                                        </option>
                                    </c:forEach>
                            ...
                            <div class="col-lg-3">
                                <label>课程名称</label>
                                <input class="form-control" type="text" name="insertName" placeholder="请输入课程名称"
                                       required>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            <div class="col-lg-3">
                                <label>教师姓名</label>
                                <input class="form-control" type="text" name="insertTeacher" placeholder="请输入教师姓名"
                                       required>
                            </div>
                        </div>
                    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                <form class="form-group col-md-12" action="<%=basePath%>admin/queryCourse.do">
                    <div class="row">
                        <div class="col-lg-3">
                            <label>学期</label>
    ...
    <div class="row">
        <div class="col-md-12">
            <form class="tile" id="deleteCourseForm" method="post">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-danger"
                                       href="javascript:deleteCourse('<%=basePath%>', '${course.id}');">删除</a>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
...
<script type="text/javascript">
    ...
    function deleteCourse(basePath, courseId) {
        ...
        deleteCourseForm.setAttribute("action", basePath + "admin/deleteCourse.do");
